    ...
    for mid_1 in model_specs:
        for mid_2 in model_specs:
            try:
                ...
                k5 = make_key_from_models(
                    model_specs[mid_2], model_specs[mid_1], conditioning_hparams
                )
...
def conditional_mutual_information_v2(prediction, model_specs):
    ...
    for mid in model_specs:
        ...
        model_metrics["gen_gap"] = (
            model_metrics["train_acc"] - model_metrics["test_acc"]
        )
    ...
    hp_values = {
        k: model_specs[all_mid[0]]["hparams"][k]["possible_values"] for k in hp_names
    }
